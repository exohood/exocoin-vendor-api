...
/**
 * A demonstration of the ExoCoin Vendor API to generate a QR code to receive payment.
 */
...
// Create a QR code for the customer for £19.95 GBP.
try {
    $qrImgUrl = $vendor->getQr(19.95, 'GBP', '0abc123def456');
    ...
    // @see https://github.com/exohood/exohood-exocoin-vendor-api
